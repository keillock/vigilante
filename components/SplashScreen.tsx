...
const SplashScreen: React.FC = () => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center h-screen transition-colors duration-1000 ${step === 0 ? 'bg-orange-500' : 'bg-white'}`}>
      <div className="flex flex-col items-center">
        <img src={logoSrc} alt="Vigilante Logo" className="w-32 h-32 mb-4 transition-opacity duration-1000" />
