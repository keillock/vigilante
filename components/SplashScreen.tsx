...
const SplashScreen: React.FC = () => {
  ...
  useEffect(() => {
    const timers = [
      setTimeout(() => setStep(1), 1500), // Cambia el color de fondo y logo después de 1.5s
      setTimeout(() => setStep(2), 3000), // Muestra el spinner después de otros 1.5s
      setTimeout(() => router.push("/login"), 4500), // Redirige al login después de 4.5s
    ];
